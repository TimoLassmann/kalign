...
class TestSequenceTypes:
    ...
    @pytest.mark.parametrize("seq_type_str,seq_type_const", [
        ("auto", kalign.AUTO),
        ("dna", kalign.DNA), 
    ...
    def test_rna_sequence_type_constants(self, seq_type_str, seq_type_const, rna_simple):
    ...
    def test_protein_sequence_type_constants(self, seq_type_str, seq_type_const, protein_simple):
