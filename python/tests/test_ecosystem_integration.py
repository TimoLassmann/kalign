...
class TestReturnFormats:
    ...
    @pytest.mark.skipif("biopython" not in sys.modules, reason="Biopython not available")
    ...
    def test_biopython_format_without_biopython(self):
        ...
        with patch.dict('sys.modules', {'Bio.Align': None, 'Bio.SeqRecord': None, 'Bio.Seq': None}):
    ...
    def test_ids_validation(self):
        ...
        # Too many IDs
        with pytest.raises(ValueError, match="Number of IDs"):
            kalign.align(TEST_SEQUENCES, fmt="plain", ids=["seq1", "seq2", "seq3", "seq4"])
...
class TestUtilsModule:
    ...
    def test_alignment_stats(self):
        ...
        required_keys = {'length', 'n_sequences', 'gap_fraction', 'conservation', 'identity'}
...
class TestBackwardCompatibility:
    ...
    def test_module_exports(self):
        ...
        expected_exports = {
            'align', 'align_from_file', 'write_alignment', 'generate_test_sequences',
            'set_num_threads', 'get_num_threads', 'kalign', 'io', 'utils',
            'DNA', 'DNA_INTERNAL', 'RNA', 'PROTEIN', 'PROTEIN_DIVERGENT', 'AUTO',
