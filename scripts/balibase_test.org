...
mat <- rbind(mat, readBaliscores("scores_kalign_full_tree.csv","kalign_fill"))
mat <- rbind(mat, readBaliscores("scores_kalign_full_tree2.csv","kalign_fill2"))

          mat <- rbind(mat,readBaliscores("scores_kalign_phmm3.csv","phmmkalign3"))
          mat <- rbind(mat,readBaliscores("scores_kalign_phmm4.csv","RV20RV30phmmkalign4"))
     mat <- rbind(mat,readBaliscores("scores_kalign_fast.csv","kalignfast"))
     mat <- rbind(mat,readBaliscores("scores_kalign_fast2.csv","kalignfast2"))
