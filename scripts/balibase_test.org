...
*** Balibase 
    ...
    #+BEGIN_SRC bash -n :tangle gen_run_balibase.sh :noweb yes :exports code :results none :noweb yes 
      ...
      find ~/kalignbenchmark/data/bb3_release -name "*.xml" | awk -v outdir="$SCRATCHDIR" '{n=split ($1,a,/[\/,.]/); printf "kalign %s -o %s/%s_%s_kalign.msf\n", $1,outdir,a[n-2],a[n-1] }' > run_kalign.sh
      chmod 755 run_kalign.sh
      ...
      find ~/kalignbenchmark/data/bb3_release -name "*.xml" | awk -v outdir="$SCRATCHDIR" '{n=split ($1,a,/[\/,.]/); ;printf "~/data/bb3_release/bali_score_src/bali_score %s %s/%s_%s_kalign.msf | grep auto\n", $1,outdir,a[n-2],a[n-1] }' > score_bb3_kalign.sh
      chmod 755  score_bb3_kalign.sh

      printf "Generating muscle scoring run script\n";
      find ~/kalignbenchmark/data/bb3_release -name "*.xml" | awk -v outdir="$SCRATCHDIR" '{n=split ($1,a,/[\/,.]/); ;printf "~/data/bb3_release/bali_score_src/bali_score %s %s/%s_%s_muscle.msf | grep auto\n", $1,outdir,a[n-2],a[n-1] }' > score_bb3_muscle.sh
      chmod 755  score_bb3_muscle.sh

      printf "Generating clustalo scoring run script\n";
      find ~/kalignbenchmark/data/bb3_release -name "*.xml" | awk -v outdir="$SCRATCHDIR" '{n=split ($1,a,/[\/,.]/); ;printf "~/data/bb3_release/bali_score_src/bali_score %s %s/%s_%s_clustalo.msf | grep auto\n", $1,outdir,a[n-2],a[n-1] }' > score_bb3_clustalo.sh
...
*** Bralibase 
    ...
    #+BEGIN_SRC bash -n :tangle gen_run_bralibase.sh :noweb yes :exports code :results none :noweb yes 
      ...
      find ~/kalignbenchmark/data/data-set1  ~/kalignbenchmark/data/data-set2 -name "*.fa"  -o -name '*.fasta' | grep structural |  awk -v outdir="$SCRATCHDIR" '{printf "kalign %s --rename -r -f msf -o %s.msf\n", $1,$1 }' > run_kalign_reformat.sh
      find ~/kalignbenchmark/data/data-set1  ~/kalignbenchmark/data/data-set2 -name "*.fa"  -o -name '*.fasta' | grep unaligned |  awk -v outdir="$SCRATCHDIR" '{printf "kalign %s --rename -r -f fasta -o %s_test.fa\n", $1,$1 }' >> run_kalign_reformat.sh
      chmod 755 run_kalign_reformat.sh
      ./run_kalign_reformat.sh

      printf "Generating kalign run script\n";
      find ~/kalignbenchmark/data/data-set1  ~/kalignbenchmark/data/data-set2  -name "*_test.fa" | grep unaligned |  awk -v outdir="$SCRATCHDIR" '{n=split ($1,a,/[\/,.]/); printf "kalign %s -o %s/%s_%s_%s_kalign.msf\n", $1,outdir,a[n-4],a[n-3],a[n-2] }' > run_kalign_bralibase.sh
      ...
      printf "Generating kalign scoring run script\n";
      find ~/kalignbenchmark/data/data-set1  ~/kalignbenchmark/data/data-set2 -name "*.msf" | grep structural | awk -v outdir="$SCRATCHDIR" '{name=$1; gsub(/structural/, "unaligned"); n=split ($1,a,/[\/,.]/); printf "~/data/bb3_release/bali_score_src/bali_score %s %s/%s_%s_%s_kalign.msf | grep auto\n", name,outdir,a[n-4],a[n-3],a[n-2] }' > score_kalign_bralibase.sh
...
**** 
    ...
    #+BEGIN_SRC bash -n :tangle gen_run_homfam.sh :noweb yes :exports code :results none :noweb yes
      ...
      printf "Generating kalign run script\n";
      find ~/kalignbenchmark/data/homfam  -name "*_test-only.vie" | awk -v outdir="$SCRATCHDIR" '{ printf "(time kalign %s -o %s/kalign.msf) 2>> homfam_timing.txt \n", $1,outdir }' >> run_homfam.sh
      

      printf "Generating muscle run script\n";
      find ~/kalignbenchmark/data/homfam  -name "*_test-only.vie" |  awk -v outdir="$SCRATCHDIR" '{printf "(time muscle3.8.31_i86linux32 -msf -in %s -out  %s/muscle.msf) 2>> homfam_timing.txt\n", $1,outdir}' >> run_homfam.sh
