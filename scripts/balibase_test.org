...
library(cowplot)
   ...
   #+BEGIN_SRC R :session one :results output graphics :file BalibaseSP_scores.jpeg :exports both :width 160 :height 80
     mat <- readBaliscores("scores_kalign_old.csv","oldkalign")
     mat <- rbind(mat,readBaliscores("scores_kalign_bikmer.csv","bikmer"));

     mat <- rbind(mat,readBaliscores("scores_kalign_bibpm.csv","bibpm"));
     mat <- rbind(mat,readBaliscores("scores_kalign_bibpm_zero.csv","bibpm_zero"));
